...
import WarfarinPharmacogenomicsDiseases from "./WarfarinPharmacogenomicsDiseases";
import WarfarinPharmacogenomicsSection from "./WarfarinPharmacogenomicsSection";
import WarfarinPharmacogenomicsWhyChoose from "./WarfarinPharmacogenomicsWhyChoose";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";


const WarfarinPharmacogenomics = () => {
  return (
    <>
...
<br />
    ...
    <DiseaseFAQ/>
    <BlogSection/> */}
    <WarfarinPharmacogenomicsDiseases/>
    <WarfarinPharmacogenomicsSection/>
    <WarfarinPharmacogenomicsWhyChoose/>
    {/* <PromoBanner/> */}
     <PromoBanner
  text="
...
export default WarfarinPharmacogenomics;