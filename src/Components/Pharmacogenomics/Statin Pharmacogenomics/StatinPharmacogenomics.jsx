...
import WarfarinPharmacogenomicsDiseases from "./StatinPharmacogenomicsDiseases";
import WarfarinPharmacogenomicsSection from "./StatinPharmacogenomicsSection";
import WarfarinPharmacogenomicsWhyChoose from "./StatinPharmacogenomicsWhyChoose";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";


const StatinPharmacogenomics = () => {
  return (
    <>
...
export default StatinPharmacogenomics;