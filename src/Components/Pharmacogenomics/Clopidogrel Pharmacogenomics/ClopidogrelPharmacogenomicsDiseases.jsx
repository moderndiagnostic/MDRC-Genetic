...
const ClopidogrelPharmacogenomicsDiseases = () => {
  return (
      ...
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center gap-10 md:gap-20">
        ...
        <div className="w-full md:w-1/2 order-2 md:order-1">
          <img
            ...
            alt="Clopidogrel Pharmacogenomics"
        ...
        <div className="w-full md:w-1/2 order-1 md:order-2">
          ...
          <h2 className="hidden md:block text-2xl md:text-3xl font-semibold text-gray-800">
            Genotype-Based Antiplatelet Therapy
          </h2>

          {/* Description */}
          <p className="text-white md:text-gray-600 text-base md:text-lg leading-relaxed mb-6 mt-3">
            MDRC provides pharmacogenomic testing to guide Clopidogrel therapy by identifying CYP2C19 variants that affect drug activation. Detection of poor metabolizers enables personalized antiplatelet strategies, optimizing efficacy and minimizing risk of adverse cardiovascular events.
          </p>
...
export default ClopidogrelPharmacogenomicsDiseases;