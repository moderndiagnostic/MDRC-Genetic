...
import ClopidogrelPharmacogenomicsDiseases from "./ClopidogrelPharmacogenomicsDiseases";
import ClopidogrelPharmacogenomicsSection from "./ClopidogrelPharmacogenomicsSection";
import ClopidogrelPharmacogenomicsWhyChoose from "./ClopidogrelPharmacogenomicsWhyChoose";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";


const ClopidogrelPharmacogenomics = () => {
  return (
    <>
...
export default ClopidogrelPharmacogenomics;