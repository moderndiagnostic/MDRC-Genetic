...
const BloodCultureKaryotypingDiseases = () => {
  return (
      ...
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center gap-10 md:gap-20">
        ...
        <div className="w-full md:w-1/2 order-2 md:order-1">
          <img
            ...
            alt="Blood Culture and Karyotyping"
        ...
        <div className="w-full md:w-1/2 order-1 md:order-2">
          ...
          <h2 className="hidden md:block text-2xl md:text-3xl font-semibold text-gray-800">
            Microbiological and Chromosomal Assessment
          </h2>

          {/* Description */}
          <p className="text-white md:text-gray-600 text-base md:text-lg leading-relaxed mb-6 mt-3">
            MDRC offers integrated blood culture and karyotyping services for comprehensive evaluation of systemic infections and genetic abnormalities. These tests provide critical information for accurate diagnosis, treatment planning, and clinical management.
          </p>
...
export default BloodCultureKaryotypingDiseases;