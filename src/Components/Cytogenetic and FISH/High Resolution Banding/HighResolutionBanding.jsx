...
import HighResolutionBandingDiseases from "./HighResolutionBandingDiseases";
import HighResolutionBandingInfoSection from "./HighResolutionBandingInfoSection";
import HighResolutionBandingWhyChoose from "./HighResolutionBandingWhyChoose";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";


const HighResolutionBanding = () => {
  return (
    <>
...
High Resolution Banding<br />
    ...
    <DiseaseFAQ/>
    <BlogSection/> */}
    <HighResolutionBandingDiseases/>
    <HighResolutionBandingInfoSection/>
    <HighResolutionBandingWhyChoose/>
    {/* <PromoBanner/> */}
     <PromoBanner
  text="
...
export default HighResolutionBanding;