      ...
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center gap-10 md:gap-20">
        ...
        <div className="w-full md:w-1/2 order-1 md:order-2">
          ...
          <h2 className="hidden md:block text-2xl md:text-3xl font-semibold text-gray-800">
            Molecular and Cytogenetic Evaluation of Reproductive Disorders
          </h2>

          {/* Description */}
          <p className="text-white md:text-gray-600 text-base md:text-lg leading-relaxed mt-3">
            Infertility genetics at MDRC focuses on identifying chromosomal and genetic factors that contribute to impaired fertility and recurrent pregnancy loss. Our comprehensive diagnostic approach integrates advanced molecular and cytogenetic techniques to provide accurate insights for reproductive health management.
          </p>
...
export default MolecularandCytogenetic;