...
import TropicalFeverPanelDiseases from "./TropicalFeverPanelDiseases";
import TropicalFeverPanelInfoSection from "./TropicalFeverPanelInfoSection";
import TropicalFeverPanelWhyChoose from "./TropicalFeverPanelWhyChoose";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";


const TropicalFeverPanel = () => {
  return (
    <>
...
<br />
    ...
    <DiseaseFAQ/>
    <BlogSection/> */}
    <TropicalFeverPanelDiseases/>
    <TropicalFeverPanelInfoSection/>
    <TropicalFeverPanelWhyChoose/>
    {/* <PromoBanner/> */}
     <PromoBanner
  text="
...
export default TropicalFeverPanel;