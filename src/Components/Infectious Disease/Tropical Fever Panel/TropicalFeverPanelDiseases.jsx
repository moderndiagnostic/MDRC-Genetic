...
const TropicalFeverPanelDiseases = () => {
  return (
      ...
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center gap-10 md:gap-20">
        ...
        <div className="w-full md:w-1/2 order-1 md:order-2">
          ...
          <h2 className="hidden md:block text-2xl md:text-3xl font-semibold text-gray-800">
            Detection of Vector-Borne Febrile Illnesses
          </h2>

          {/* Description */}
          <p className="text-white md:text-gray-600 text-base md:text-lg leading-relaxed mt-3">
            MDRC provides advanced diagnostic testing for acute febrile illnesses caused by vector-borne pathogens. The Tropical Fever Panel enables accurate and rapid identification of multiple infectious agents, supporting timely treatment and differential diagnosis in endemic regions.
          </p>
...
export default TropicalFeverPanelDiseases;