...
import STDUrethritisPanelDiseases from "./STDUrethritisPanelDiseases";
import STDUrethritisPanelInfoSection from "./STDUrethritisPanelInfoSection";
import STDUrethritisWhyChoose from "./STDUrethritisWhyChoose";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";


const STDUrethritisPanelFeverPanel = () => {
  return (
    <>
...
<br />
    ...
    <DiseaseFAQ/>
    <BlogSection/> */}
    <STDUrethritisPanelDiseases/>
    <STDUrethritisPanelInfoSection/>
    <STDUrethritisWhyChoose/>
    {/* <PromoBanner/> */}
     <PromoBanner
  text="
...
export default STDUrethritisPanelFeverPanel;