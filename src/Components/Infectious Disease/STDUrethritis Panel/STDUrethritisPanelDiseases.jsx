...
const STDUrethritisPanelDiseases = () => {
  return (
      ...
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center gap-10 md:gap-20">
        ...
        <div className="w-full md:w-1/2 order-1 md:order-2">
          ...
          <p className="text-white md:text-gray-600 text-base md:text-lg leading-relaxed mt-3">
            MDRC provides comprehensive molecular testing for sexually transmitted infections (STIs) and urethritis-causing pathogens. Our panel enables accurate identification of multiple agents, supporting precise diagnosis, treatment, and prevention of complications.
          </p>
...
export default STDUrethritisPanelDiseases;