...
import RespiratoryPanelDiseases from "./RespiratoryPanelDiseases";
import RespiratoryPanelInfoSection from "./RespiratoryPanelInfoSection";
import RespiratoryPanelWhyChoose from "./RespiratoryPanelWhyChoose";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";


const RespiratoryPanel = () => {
  return (
    <>
    ...
    <DiseaseFAQ/>
    <BlogSection/> */}
    <RespiratoryPanelDiseases/>
    <RespiratoryPanelInfoSection/>
    <RespiratoryPanelWhyChoose/>
    {/* <PromoBanner/> */}
     <PromoBanner
  text="
...
export default RespiratoryPanel;