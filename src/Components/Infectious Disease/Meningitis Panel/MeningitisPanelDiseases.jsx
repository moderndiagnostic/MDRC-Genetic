      ...
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center gap-10 md:gap-20">
        ...
        <div className="w-full md:w-1/2 order-2 md:order-1">
          <img
            ...
            alt="Neurotropic Pathogen Detection"
        ...
        <div className="w-full md:w-1/2 order-1 md:order-2">
          ...
          <h2 className="hidden md:block text-2xl md:text-3xl font-semibold text-gray-800">
            Rapid Identification of Neurotropic Pathogens
          </h2>

          {/* Description */}
          <p className="text-white md:text-gray-600 text-base md:text-lg leading-relaxed mt-3">
            MDRC provides advanced multiplex molecular testing for rapid detection of viral and bacterial pathogens causing meningitis. Early and accurate diagnosis from cerebrospinal fluid (CSF) is critical for timely treatment and prevention of severe neurological complications.
          </p>
