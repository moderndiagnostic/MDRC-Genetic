...
import MeningitisPanelDiseases from "./MeningitisPanelDiseases";
import MeningitisPanelInfoSection from "./MeningitisPanelInfoSection";
import MeningitisPanelWhyChoose from "./MeningitisPanelWhyChoose";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";



const MeningitisPanel = () => {
  return (
    <>
...
<br />
    ...
    <DiseaseFAQ/>
    <BlogSection/> */}
    <MeningitisPanelDiseases/>
    <MeningitisPanelInfoSection/>
    <MeningitisPanelWhyChoose/>
    {/* <PromoBanner/> */}
     <PromoBanner
  text="
...
export default MeningitisPanel;