...
const SpectrumofInfectiousWhyChoose = () => {
  const items = [
    {
  ...
  return (
    <div className="bg-gradient-to-r from-[#1CA3D8] to-[#0B5C8E] py-8 px-4 text-white font-roboto">
      ...
      <h2 className="text-center text-2xl md:text-[25px] font-semibold mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-5xl mx-auto">
        {items.map((item, index) => (
          ...
          >
            {/* Image Circle */}
            <div className="flex items-center justify-center w-18 h-18 rounded-full bg-white mr-3 shrink-0">
              <img
                src={item.img}
                alt="icon"
...
export default SpectrumofInfectiousWhyChoose;