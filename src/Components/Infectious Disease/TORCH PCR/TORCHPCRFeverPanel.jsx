...
import TORCHPCRFeverPanelDiseases from "./TORCHPCRFeverPanelDiseases";
import TORCHPCRFeverPanelInfoSection from "./TORCHPCRFeverPanelInfoSection";
import TORCHPCRFeverPanelWhyChoose from "./TORCHPCRFeverPanelWhyChoose";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";


const TORCHPCRFeverPanel = () => {
  return (
    <>
...
<br />
    ...
    <DiseaseFAQ/>
    <BlogSection/> */}
    <TORCHPCRFeverPanelDiseases/>
    <TORCHPCRFeverPanelInfoSection/>
    <TORCHPCRFeverPanelWhyChoose/>
    {/* <PromoBanner/> */}
     <PromoBanner
  text="
...
export default TORCHPCRFeverPanel;