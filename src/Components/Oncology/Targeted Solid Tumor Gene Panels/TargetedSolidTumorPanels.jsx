...
import TargetedSolidTumorPanelsDiseases from "./TargetedSolidTumorPanelsDiseases";
import TargetedSolidTumorPanelsSection from "./TargetedSolidTumorPanelsSection";
import TargetedSolidTumorPanelsWhyChoose from "./TargetedSolidTumorPanelsWhyChoose";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";


const TargetedSolidTumorPanels = () => {
  return (
    <>
        ...
        <div className="metab-hero-inner max-w-7xl mx-auto px-4 sm:px-6 md:px-10 py-5 sm:py-8 md:py-16 lg:py-20 flex flex-col md:flex-row items-center justify-between gap-5 sm:gap-7 md:gap-10">
          ...
          <div className="text-white text-center md:text-left w-full md:w-1/2">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold leading-tight tracking-tight">
              <span className="block">Targeted Solid Tumor</span>
              <span className="block">Gene Panels</span>
            </h1>
    ...
    <DiseaseFAQ/>
    <BlogSection/> */}
    <TargetedSolidTumorPanelsDiseases/>
    <TargetedSolidTumorPanelsSection/>
    <TargetedSolidTumorPanelsWhyChoose/>
    {/* <PromoBanner/> */}
     <PromoBanner
  text="
...
export default TargetedSolidTumorPanels;