...
import GenomeSequencingDiseases from "./ExomeSequencingDiseases";
import GenomeSequencingInfoSection from "./ExomeInfoSection";
import GenomeSequencingWhyChoose from "./ExomeInfoSectionWhyChoose";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";


const ExomeSequencing = () => {
  return (
    <>
...
<br />
    ...
    <DiseaseFAQ/>
    <BlogSection/> */}
    <GenomeSequencingDiseases/>
    <GenomeSequencingInfoSection/>
    <GenomeSequencingWhyChoose/>
    {/* <PromoBanner/> */}
     <PromoBanner
  text="
...
export default ExomeSequencing;