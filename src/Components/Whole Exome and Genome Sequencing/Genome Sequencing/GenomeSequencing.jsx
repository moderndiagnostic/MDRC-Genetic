...
import GenomeSequencingDiseases from "./GenomeSequencingDiseases";
import GenomeSequencingInfoSection from "./GenomeSequencingInfoSection";
import GenomeSequencingWhyChoose from "./GenomeSequencingWhyChoose";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";


const GenomeSequencing = () => {
  return (
    <>
