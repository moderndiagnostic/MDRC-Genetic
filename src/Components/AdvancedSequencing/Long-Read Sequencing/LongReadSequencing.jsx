...
import WholeGenomeSequencingDiseases from "./LongReadDiseases";
import WholeGenomeSequencingSection from "./LongReadSection";
import WholeGenomeSequencingWhyChoose from "./LongReadWhyChoose";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";


const LongReadSequencing = () => {
  return (
    <>
...
export default LongReadSequencing;