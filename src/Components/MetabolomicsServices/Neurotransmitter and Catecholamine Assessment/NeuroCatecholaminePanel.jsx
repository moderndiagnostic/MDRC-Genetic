...
import NeuroCatecholamineIntro from "./NeuroCatecholamineIntro";
import NeuroCatecholamineWhy from "./NeuroCatecholamineWhy";
import NeuroCatecholamineMarkers from "./NeuroCatecholamineMarkers";
import NeuroCatecholamineIntervention from "./NeuroCatecholamineIntervention";
import NeuroCatecholamineTracking from "./NeuroCatecholamineTracking";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";

const NeuroCatecholaminePanel = () => {
  return (
    <>
      <div className="font-roboto">
            ...
            <div className="relative flex justify-center items-center w-full md:w-auto py-1 sm:py-3 md:py-8 shrink-0">
              <div className="metab-hero-circle relative w-[160px] h-[160px] sm:w-[220px] sm:h-[220px] md:w-[320px] md:h-[320px] lg:w-[400px] lg:h-[400px]">
                ...
                <div className="relative overflow-hidden rounded-full w-full h-full border-2 md:border-[1px] border-[#000000] shadow-[0_0_16px_6px_rgba(255,255,255,0.28)] md:shadow-[0_0_72px_28px_rgba(255,255,255,0.46)] box-border">
                  <img
                    src="https://images.unsplash.com/photo-1639772823849-6efbd173043c?auto=format&fit=crop&crop=entropy&w=1200&h=1200&q=80"
                    alt="Neurotransmitter and Catecholamine Assessment Panel"
        ...
        <NeuroCatecholamineIntro />
      </div>

      <NeuroCatecholamineWhy />
      <NeuroCatecholamineMarkers />
      <NeuroCatecholamineIntervention />
      <NeuroCatecholamineTracking />

      <PromoBanner
        text="Ready to decode your stress axis and brain chemistry? Book the Neuro-Endocrine, Catecholamine & Pathway Balance Panel today."
...
export default NeuroCatecholaminePanel;
