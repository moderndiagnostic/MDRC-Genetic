...
const interventions = [
  ...
  },
  {
    ...
    desc: "Implementing specific dietary modifications and barrier supports to stop toxic gut metabolites from crossing into circulation and triggering low-grade neuroinflammation.",
  },
];

const DepressionIntervention = () => {
  return (
...
export default DepressionIntervention;
