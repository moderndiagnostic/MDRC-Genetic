...
import AutismIntro from "./AutismIntro";
import AutismMarkers from "./AutismMarkers";
import AutismIntervention from "./AutismIntervention";
import AutismTracking from "./AutismTracking";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";
import heroImg from "../../../assets/autism-assessment-hero.png";
...
const AutismPanel = () => {
  return (
    <>
      ...
      <PromoBanner
        text="Ready to map the biochemical pathways behind autism support? Book the Comprehensive Neuro-Metabolic, Methylation & Gut-Brain Axis Panel today."
