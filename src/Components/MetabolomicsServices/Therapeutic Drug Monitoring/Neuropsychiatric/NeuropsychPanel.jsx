...
import NeuropsychIntro from "./NeuropsychIntro";
import NeuropsychWhy from "./NeuropsychWhy";
import NeuropsychMarkers from "./NeuropsychMarkers";
import NeuropsychPrecision from "./NeuropsychPrecision";
import NeuropsychIntervention from "./NeuropsychIntervention";
import NeuropsychTracking from "./NeuropsychTracking";
import PromoBanner from "../../../HealthPregnancy/InfertilityGenetics/PromoBanner";
import heroImg from "../../../../assets/tdm-neuropsych-hero.png";

const NeuropsychPanel = () => {
  return (
    <>
        ...
        <section className="relative overflow-hidden md:overflow-visible text-white bg-gradient-to-b from-[#005E91] to-[#0C759A] lg:pt-20">
          <div className="metab-hero-inner max-w-7xl mx-auto px-4 sm:px-6 md:px-10 py-5 sm:py-8 md:py-16 lg:py-20 flex flex-col md:flex-row items-center justify-between gap-5 sm:gap-7 md:gap-10">
            <div className="text-white text-center md:text-left w-full md:w-1/2">
              ...
              <span className="block">Neuropsychiatric Drugs</span>
              <span className="block">(Neuroleptics & Anti-Epileptics)</span>
            </h1>
              <h3 className="mt-4 text-base sm:text-lg md:text-xl font-normal opacity-90 max-w-xl mx-auto md:mx-0 leading-relaxed">
                LC-MS/MS therapeutic drug monitoring for antipsychotics and
                anticonvulsants to personalize dosing and protect organ safety.
              </h3>
            </div>
      ...
      <NeuropsychMarkers />
      <NeuropsychPrecision />
      <NeuropsychIntervention />
      <NeuropsychTracking />
      <PromoBanner
        text="Ready to stabilize therapy with gold-standard neuropsychiatric TDM? Book the Neuroleptics & Anti-Epileptics panel today."
...
export default NeuropsychPanel;
