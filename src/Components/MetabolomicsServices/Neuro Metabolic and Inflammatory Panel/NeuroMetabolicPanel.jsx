...
import NeuroMetabolicIntro from "./NeuroMetabolicIntro";
import NeuroMetabolicClarity from "./NeuroMetabolicClarity";
import NeuroMetabolicMarkers from "./NeuroMetabolicMarkers";
import NeuroMetabolicIntervention from "./NeuroMetabolicIntervention";
import NeuroMetabolicTracking from "./NeuroMetabolicTracking";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";
import heroImg from "../../../assets/neuro-metabolic-hero.png";

const NeuroMetabolicPanel = () => {
  return (
    <>
            ...
            <div className="relative flex justify-center items-center w-full md:w-auto py-4 sm:py-5 md:py-8">
              <div className="relative w-[210px] h-[210px] sm:w-[250px] sm:h-[250px] md:w-[350px] md:h-[350px] lg:w-[400px] lg:h-[400px]">
                ...
                <div className="relative overflow-hidden rounded-full w-full h-full border-2 md:border-[1px] border-[#000000] shadow-[0_0_28px_10px_rgba(255,255,255,0.35)] md:shadow-[0_0_72px_28px_rgba(255,255,255,0.46)] box-border">
                  <img
                    src={heroImg}
                    alt="Neuro-Metabolic and Inflammatory Panel"
      ...
      <NeuroMetabolicClarity />
      <NeuroMetabolicMarkers />
      <NeuroMetabolicIntervention />
      <NeuroMetabolicTracking />

      <PromoBanner
        text="Ready to take control of your neuro-metabolic health? Book the Neuro-Metabolic & Neuro-Inflammatory Burden Panel today."
...
export default NeuroMetabolicPanel;
