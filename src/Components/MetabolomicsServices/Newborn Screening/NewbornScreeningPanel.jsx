...
import NewbornScreeningIntro from "./NewbornScreeningIntro";
import NewbornScreeningPrevention from "./NewbornScreeningPrevention";
import NewbornScreeningMarkers from "./NewbornScreeningMarkers";
import NewbornScreeningPrecision from "./NewbornScreeningPrecision";
import NewbornScreeningIntervention from "./NewbornScreeningIntervention";
import NewbornScreeningTracking from "./NewbornScreeningTracking";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";
import heroImg from "../../../assets/newborn-screening-hero.png";

const NewbornScreeningPanel = () => {
  return (
    <>
      <div className="font-roboto">
        <section className="relative overflow-hidden md:overflow-visible text-white bg-gradient-to-b from-[#005E91] to-[#0C759A] lg:pt-20">
          <div className="metab-hero-inner max-w-7xl mx-auto px-4 sm:px-6 md:px-10 py-5 sm:py-8 md:py-16 lg:py-20 flex flex-col md:flex-row items-center justify-between gap-5 sm:gap-7 md:gap-10">
            <div className="text-white text-center md:text-left w-full md:w-1/2">
              ...
              <span className="block">New Born Screening for</span>
              <span className="block">Errors of Metabolism</span>
            </h1>

              <h3 className="mt-4 text-base sm:text-lg md:text-xl font-normal opacity-90 max-w-xl mx-auto md:mx-0 leading-relaxed">
                A dried blood spot MS/MS panel screening amino acids and acylcarnitines
                to detect inborn errors of metabolism before symptoms appear.
              </h3>
            </div>
            ...
            <div className="relative flex justify-center items-center w-full md:w-auto py-1 sm:py-3 md:py-8 shrink-0">
              <div className="metab-hero-circle relative w-[160px] h-[160px] sm:w-[220px] sm:h-[220px] md:w-[320px] md:h-[320px] lg:w-[400px] lg:h-[400px]">
                ...
                <div className="relative overflow-hidden rounded-full w-full h-full border-2 md:border-[1px] border-[#000000] shadow-[0_0_16px_6px_rgba(255,255,255,0.28)] md:shadow-[0_0_72px_28px_rgba(255,255,255,0.46)] box-border">
                  <img
                    src={heroImg}
                    alt="New Born Screening for Errors of Metabolism"
        ...
        <NewbornScreeningIntro />
      </div>

      <NewbornScreeningPrevention />
      <NewbornScreeningMarkers />
      <NewbornScreeningPrecision />
      <NewbornScreeningIntervention />
      <NewbornScreeningTracking />

      <PromoBanner
        text="Ready to protect your newborn with gold-standard metabolic screening? Book the Newborn Screening Panel for Amino Acids & Acylcarnitines today."
...
export default NewbornScreeningPanel;
