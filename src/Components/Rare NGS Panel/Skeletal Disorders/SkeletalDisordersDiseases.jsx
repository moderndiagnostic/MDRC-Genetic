...
const SkeletalDisordersDiseases = () => {
  return (
      ...
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center gap-10 md:gap-20">
        ...
        <div className="w-full md:w-1/2 order-1 md:order-2">
          ...
          <h2 className="hidden md:block text-2xl md:text-3xl font-semibold text-gray-800">
            Genetic Evaluation of Bone and Connective Tissue Conditions
          </h2>

          {/* Description */}
          <p className="text-white md:text-gray-600 text-base md:text-lg leading-relaxed mb-6 mt-3">
            MDRC provides advanced molecular testing for skeletal and connective tissue disorders. Genetic sequencing identifies mutations responsible for skeletal dysplasias and connective tissue abnormalities, enabling accurate diagnosis, classification, and prognosis assessment.
          </p>
...
export default SkeletalDisordersDiseases;