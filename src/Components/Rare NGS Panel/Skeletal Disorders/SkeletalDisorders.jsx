...
import CardiogeneticDisordersDiseases from "./SkeletalDisordersDiseases";
import CardiogeneticDisordersInfoSection from "./SkeletalDisordersInfoSection";
import CardiogeneticDisordersWhyChoose from "./SkeletalDisordersWhyChoose";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";


const SkeletalDisorders = () => {
  return (
    <>
...
export default SkeletalDisorders;