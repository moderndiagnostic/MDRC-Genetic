...
import CardiogeneticDisordersDiseases from "./CardiogeneticDisordersDiseases";
import CardiogeneticDisordersInfoSection from "./CardiogeneticDisordersInfoSection";
import CardiogeneticDisordersWhyChoose from "./CardiogeneticDisordersWhyChoose";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";


const CardiogeneticDisorders = () => {
  return (
    <>
...
<br />
    ...
    <DiseaseFAQ/>
    <BlogSection/> */}
    <CardiogeneticDisordersDiseases/>
    <CardiogeneticDisordersInfoSection/>
    <CardiogeneticDisordersWhyChoose/>
    {/* <PromoBanner/> */}
     <PromoBanner
  text="
...
export default CardiogeneticDisorders;