...
const OncogeneticsDisordersDiseases = () => {
  return (
      ...
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center gap-10 md:gap-20">
        ...
        <div className="w-full md:w-1/2 order-1 md:order-2">
          ...
          <h2 className="hidden md:block text-2xl md:text-3xl font-semibold text-gray-800">
            Genetic Evaluation of Hereditary Cancer Syndromes
          </h2>

          {/* Description */}
          <p className="text-white md:text-gray-600 text-base md:text-lg leading-relaxed mb-6 mt-3">
            MDRC provides advanced genomic testing for inherited cancer syndromes.
            Molecular analysis identifies germline mutations that increase
            susceptibility to various cancers, enabling early risk assessment,
            targeted surveillance, and personalized oncology management.
          </p>
...
export default OncogeneticsDisordersDiseases;