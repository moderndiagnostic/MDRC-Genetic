...
import OncogeneticsDisordersDiseases from "./OncogeneticsDisordersDiseases";
import OncogeneticsInfoSection from "./OncogeneticsInfoSection";
import OncogeneticsDisordersWhyChoose from "./OncogeneticsDisordersWhyChoose";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";


const OncogeneticsDisorders = () => {
  return (
    <>
...
<br />
    ...
    <DiseaseFAQ/>
    <BlogSection/> */}
    <OncogeneticsDisordersDiseases/>
    <OncogeneticsInfoSection/>
    <OncogeneticsDisordersWhyChoose/>
    {/* <PromoBanner/> */}
     <PromoBanner
  text="
...
export default OncogeneticsDisorders;