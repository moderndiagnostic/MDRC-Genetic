...
const HematologicalGeneticDisordersDiseases = () => {
  return (
      ...
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center gap-10 md:gap-20">
        ...
        <div className="w-full md:w-1/2 order-2 md:order-1">
          <img
            ...
            alt="Hematological Genetic Disorders"
        ...
        <div className="w-full md:w-1/2 order-1 md:order-2">
          ...
          <h2 className="hidden md:block text-2xl md:text-3xl font-semibold text-gray-800">
            Molecular Basis of Inherited Blood Disorders
          </h2>

          {/* Description */}
          <p className="text-white md:text-gray-600 text-base md:text-lg leading-relaxed mb-6 mt-3">
            MDRC provides advanced genetic testing for inherited blood disorders.
            Molecular analysis identifies pathogenic variants affecting hemoglobin
            synthesis, coagulation pathways, and platelet function, supporting
            precise diagnosis and personalized management strategies.
          </p>
...
export default HematologicalGeneticDisordersDiseases;