...
import OphthalmicGeneticDisordersDiseases from "./OphthalmicGeneticDisordersDiseases";
import OphthalmicGeneticDisordersDiseasesInfoSection from "./OphthalmicGeneticDisordersDiseasesInfoSection";
import OphthalmicGeneticDisordersWhyChoose from "./OphthalmicGeneticDisordersWhyChoose";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";


const OphthalmicGeneticDisorders = () => {
  return (
    <>
...
<br />
    ...
    <DiseaseFAQ/>
    <BlogSection/> */}
    <OphthalmicGeneticDisordersDiseases/>
    <OphthalmicGeneticDisordersDiseasesInfoSection/>
    <OphthalmicGeneticDisordersWhyChoose/>
    {/* <PromoBanner/> */}
     <PromoBanner
  text="
...
export default OphthalmicGeneticDisorders;