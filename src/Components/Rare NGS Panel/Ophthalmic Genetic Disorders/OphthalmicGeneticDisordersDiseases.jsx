...
const OphthalmicGeneticDisordersDiseases = () => {
  return (
      ...
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center gap-10 md:gap-20">
        ...
        <div className="w-full md:w-1/2 order-2 md:order-1">
          <img
            ...
            alt="Ophthalmic Genetic Disorders"
        ...
        <div className="w-full md:w-1/2 order-1 md:order-2">
          ...
          <h2 className="hidden md:block text-2xl md:text-3xl font-semibold text-gray-800">
            Molecular Diagnosis of Inherited Eye Diseases
          </h2>

          {/* Description */}
          <p className="text-white md:text-gray-600 text-base md:text-lg leading-relaxed mb-6 mt-3">
            MDRC offers advanced genetic testing for inherited ophthalmic disorders. Molecular analysis identifies pathogenic variants associated with retinal dystrophies and other hereditary visual impairments, supporting precise diagnosis, classification, and clinical management.
          </p>
...
export default OphthalmicGeneticDisordersDiseases;