...
import PediatricGeneticDisordersDiseases from "./PediatricGeneticDisordersDiseases";
import PediatricGeneticDisordersInfoSection from "./PediatricGeneticDisordersInfoSection";
import PediatricGeneticDisordersWhyChoose from "./PediatricGeneticDisordersWhyChoose";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";


const PediatricGeneticDisorders = () => {
  return (
    <>
...
<br />
    ...
    <DiseaseFAQ/>
    <BlogSection/> */}
    <PediatricGeneticDisordersDiseases/>
    <PediatricGeneticDisordersInfoSection/>
    <PediatricGeneticDisordersWhyChoose/>
    {/* <PromoBanner/> */}
     <PromoBanner
  text="
...
export default PediatricGeneticDisorders;