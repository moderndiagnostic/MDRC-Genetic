...
import ImmunologicalDisordersDiseases from "./ImmunologicalDisordersDiseases";
import ImmunologicalInfoSection from "./ImmunologicalInfoSection";
import ImmunologicalWhyChoose from "./ImmunologicalWhyChoose";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";


const ImmunologicalDisorders = () => {
  return (
    <>
...
Immunological Disorders<br />
    ...
    <DiseaseFAQ/>
    <BlogSection/> */}
    <ImmunologicalDisordersDiseases/>
    <ImmunologicalInfoSection/>
    <ImmunologicalWhyChoose/>
    {/* <PromoBanner/> */}
     <PromoBanner
  text="
