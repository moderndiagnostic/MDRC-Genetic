...
import OphthalmicGeneticDisordersDiseases from "./RenalGeneticDisordersDiseases";
import OphthalmicGeneticDisordersDiseasesInfoSection from "./RenalGeneticDisordersInfoSection";
import OphthalmicGeneticDisordersWhyChoose from "./RenalGeneticDisordersWhyChoose";
import PromoBanner from "../../HealthPregnancy/InfertilityGenetics/PromoBanner";


const RenalGeneticDisorders = () => {
  return (
    <>
...
export default RenalGeneticDisorders;