...
const RenalGeneticDisordersDiseases = () => {
  return (
      ...
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center gap-10 md:gap-20">
        ...
        <div className="w-full md:w-1/2 order-1 md:order-2">
          ...
          <h2 className="hidden md:block text-2xl md:text-3xl font-semibold text-gray-800">
            Genetic Analysis of Hereditary Kidney Diseases
          </h2>

          {/* Description */}
          <p className="text-white md:text-gray-600 text-base md:text-lg leading-relaxed mb-6 mt-3">
            MDRC provides advanced genomic testing for inherited renal disorders.
            Molecular analysis identifies pathogenic variants associated with cystic
            kidney disease, glomerular disorders, and tubular dysfunction,
            supporting accurate diagnosis and personalized clinical management.
          </p>
...
export default RenalGeneticDisordersDiseases;